...
\title[PHY 505 Project 2]{Mesons Beyond \su3flavor \qqbar}
...
\date[19 March 2014]{19 March 2014}
...
\begin{frame}
  \frametitle{Outline}
  \begin{itemize}
  \item Introduction to non \su3flavor mesons.
  \item Theoretical states:
    \begin{itemize}
    \item QCD Hybrids
    \item Glueballs
    \item Tetraquarks
    \end{itemize}
  \item Discussion of the $\pi_1(1400)$ and $\pi_1(1600)$ exotics.
  \item Discussion of the $Z(4430)$ tetraquark.
  \item Summary
  \end{itemize}
\end{frame}
