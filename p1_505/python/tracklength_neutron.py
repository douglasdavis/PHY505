...
file_F_Pb = ROOT.TFile('../data/FTFP_Pb_N.root')
file_F_PP = ROOT.TFile('../data/FTFP_PP_N.root')
file_F_H2 = ROOT.TFile('../data/FTFP_H2O_N.root')

tree_F_Pb = file_F_Pb.Get('RunTree')
tree_F_PP = file_F_PP.Get('RunTree')
tree_F_H2 = file_F_H2.Get('RunTree')

h_F_Pb = ROOT.TH1D('h_F_Pb',';Avg. Track Length/Layer;N events',50,0,100)
h_F_PP = ROOT.TH1D('h_F_PP',';Avg. Track Length/Layer;N events',50,0,100)
h_F_H2 = ROOT.TH1D('h_F_H2',';Avg. Track Length/Layer;N events',50,0,100)
