...
// ********************************************************************
//
// $Id: CalorimeterSD.cc 87359 2014-12-01 16:04:27Z gcosmo $
//
...
{  
  ...
  CalorHit* hit = (*fHitsCollection)[layerNumber];
  if ( ! hit ) {
  ...
  CalorHit* hitTotal = (*fHitsCollection)[fHitsCollection->entries()-1];
